      ...
      {redirect ? <Navigate to={'/'} /> : null}
        <div>
          <article>
            ...
            <div className="prose lg:prose-xl prose-pre:text-left pre-direction prose-h1:text-purple-600 prose-h2:text-purple-600 prose-h3:text-purple-600 prose-h4:text-purple-600 prose-h5:text-purple-600 prose-h6:text-purple-600 max-w-none text-justify">{post && md.render(post.body)}</div>
          </article>
        </div>
      </main>
    </div>
